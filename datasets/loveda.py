...
def get_training_transform():
    train_transform = [
        ...
        albu.ElasticTransform(alpha=1.0, sigma=50.0, alpha_affine=50.0, p=0.5),
...
def train_aug(img, mask):
    ...
    crop_aug = Compose([RandomScale(scale_list=[0.75, 1.0, 1.25, 1.5], mode='value'),
                        SmartCropV1(crop_size=512, max_ratio=0.75, nopad=False)])
...
#loveda_val_dataset = LoveDATrainDataset(data_root='data/LoveDA/Val', mosaic_ratio=0.0,transform=val_aug)
